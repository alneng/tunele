    ...
    <div className="bg-gray-100 py-8 overflow-y-auto h-full">
      <div className="container mx-auto px-4">
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <p>
            We use your information solely for the purpose of creating and
            maintaining your user account on Tunele. Your data is never sold or
          ...
          <p>
            Tunele may use cookies and analytics tools to improve our services
            and enhance your experience. These tools collect non-personal
            information, such as website usage patterns.
          </p>
          ...
          <p>
            ...
            the privacy policies of those websites separately.
          </p>
