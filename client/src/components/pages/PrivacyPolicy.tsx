		...
		<div className="bg-gray-100 py-8 overflow-y-auto h-full">
			<div className="container mx-auto px-4">
				<h1 className="text-3xl font-semibold mb-4">
					Tunele Privacy Policy
				</h1>
				<p className="text-gray-600 mb-8">
					Effective as of{" "}
					<span className="underline">5 Oct 2023</span>
				</p>
				...
				<div className="bg-white rounded-lg shadow-md p-6">
					...
					<p>
						...
						creating and maintaining your user account on Tunele.
					...
					<p>
						...
						your data from unauthorized access, alteration,
					...
					<p>
						Tunele may use cookies and analytics tools to improve
						our services and enhance your experience. These tools
						collect non-personal information, such as website usage
						patterns.
					</p>
					...
					<p>
						...
						content. Please review the privacy policies of those
						websites separately.
					</p>
					...
					<p className="text-sm text-gray-600 mt-8">
						By using Tunele, you agree to the terms of this Privacy
						Policy.
					</p>
				</div>
			</div>
